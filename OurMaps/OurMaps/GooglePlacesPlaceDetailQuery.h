...
/*!
 Application's API key. This key identifies the application for purposes of quota management. Visit the APIs Console to select an API Project and obtain the key. Maps API for Business customers must use the API project created for them as part of their Places for Business purchase. Defaults to kGoogleAPIKey.
 */
